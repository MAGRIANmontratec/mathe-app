...
export default function App() {
  ...
  const generateQuestion = (targetMode: GameMode) => {
    ...
    if (targetMode === "multiplication") {
      ...
      const problems = [
        { text: "Linus baut 6 Türme. Jeder Turm hat 10 Klötze. Wie viele Klötze sind es insgesamt?", ans: 60 },
        { text: "Im Blumenbeet wachsen 45 Astern und 36 Rosen. Wie viele Blumen sind es zusammen?", ans: 81 },
        { text: "Monika hat 50€ gespart. Oma gibt ihr 11€. Dann kauft sie ein Bastelset für 24€. Wie viel Geld hat sie noch?", ans: 37 },
        { text: "Karl geht 3-mal am Tag mit seinem Hund raus. Jedes Mal sind sie 30 Minuten unterwegs. Wie viele Minuten sind sie insgesamt unterwegs?", ans: 90 },
        { text: "Anna hat 40€ im Geldbeutel. Sie kauft ein Mäppchen für 12€, 3 Stifte für je 4€ und ein Eis für 3€. Wie viel Geld hat sie noch übrig?", ans: 13 },
      ];
    ...
    <div className="min-h-screen bg-slate-100 flex flex-col items-center justify-center p-4 font-sans safe-area-inset">
      <div className="bg-white p-6 rounded-3xl shadow-xl w-full max-w-3xl text-center relative">
        ...
        <div className="overflow-y-auto px-1 max-h-[75vh]">
          <CategorySection
            title="Klasse 3: Raum & Größen"
            cat="grade3"
            modes={["cube_buildings", "geometry_shapes", "units_length", "units_weight", "word_problem_units"]}
            onStart={startGame}
          />
          <CategorySection
